...
class ProductTest < ActiveSupport::TestCase
  ...
  #   assert true
  # end
  # test para la existencia de atributos
  ...
  # test para el precio de un producto -1 o 0 no son validos
  ...
  # metodo que recibe la imagen_url del producto
  def new_product(image_url)
    Product.new(title: 'My Book Title', description: 'yyy', price: 1, image_url: image_url)
  end

  # test para verificar el formato de la imagen del producto
  test 'image url' do
  ...
  # test para verificar que titulo sea unico , recibe fixture "ruby"
